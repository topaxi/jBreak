jBreak.options = {
	showOptions:function(){
		...
		this.$optionTabs.append('<div id="tabs-3" style="text-align:center;height:220px"><p>jBreak @VERSION</p><p style="font-size:11px">Written by Damian Senn<br /><br />Graphics and Sounds<br />by <a href="http://www.helleresonnen.com/">Jan Neversil</a><br /><br />Music (coming soon)<br />by <a href="http://www.alphatronic.net/">Dani Whiler</a></p></div>');
